...
var flow_path = '/root/record_scores';
...
casper.then(function() {{techo('load \'+csv_file+\' to lines');
var fs = require('fs'); lines = '';
if (fs.exists(''+abs_file(''+csv_file+'')+''))
lines = fs.read(''+abs_file(''+csv_file+'')+'').trim();
else this.echo('ERROR - cannot find file '+csv_file+'').exit();}});
...
casper.then(function() {for (n=1; n<items.length; n++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][n]';});
(function (n) { // start of IIFE pattern
{ // start of code block

casper.then(function() {if (((items[n].trim()=='学号') || (items[n].trim()=='考号')))
{ // start of code block
...
casper.then(function() {if (((items[n].trim()=='期末') || (items[n].trim()=='总分')))
{ // start of code block
...
casper.then(function() {if (((items[n].trim()=='期中')))
{ // start of code block
...
casper.then(function() {if (((items[n].trim()=='平时成绩3') || (items[n].trim()=='平时成绩I')))
{ // start of code block
...
casper.then(function() {if (((items[n].trim()=='平时成绩2') || (items[n].trim()=='平时成绩II')))
{ // start of code block
...
casper.then(function() {if (((items[n].trim()=='平时成绩1') || (items[n].trim()=='平时成绩Ⅲ')))
{ // start of code block
...
casper.then(function() {this.echo(number_col+' '+end_col+' '+middle_col+' '+u3_col+' '+u2_col+' '+u1_col);});
...
casper.then(function() {{techo('write csv_row(period) to period.csv');
append_text('/root/record_scores/period.csv',csv_row(period));}});

casper.then(function() { // start of JS code
items = array_lines[1].split(',')
}); // end of JS code

casper.then(function() {if (((u1_col!=-1) && (items[u1_col]!='')))
{ // start of code block
...
casper.then(function() {{techo('write csv_row([str]) to period.csv');
append_text('/root/record_scores/period.csv',csv_row([str]));}});

} // end of code block
});

casper.then(function() {if (((u2_col!=-1) && (items[u2_col]!='')))
{ // start of code block
...
casper.then(function() {if (((u3_col!=-1) && (items[u3_col]!='')))
{ // start of code block
...
casper.then(function() {if (((middle_col!=-1) && (items[middle_col]!='')))
{ // start of code block
...
casper.then(function() {if (((end_col!=-1) && (items[end_col]!='')))
{ // start of code block
...
casper.then(function() {{techo('write now+\'录分流程开始\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'录分流程开始');}});
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://jx.sspu.edu.cn/eams/caslogin.action'}); sleep(1000);
techo('https://jx.sspu.edu.cn/eams/caslogin.action' + ' - ' + chrome.getTitle());});
...
casper.then(function() {{techo('dclick //input[@id="username"]');
casper.waitFor(function check() {return check_tx('//input[@id="username"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@id="username"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@id="username"]').exit();});}});

casper.then(function() {techo('wait 1');});
casper.then(function() {casper.wait(1000, function() {});});

casper.then(function() {{techo('enter //input[@id="username"] as '+username+'');
casper.waitFor(function check() {return check_tx('//input[@id="username"]');},
function then() {chrome.sendKeys(tx('//input[@id="username"]'),''+username+'');},
function timeout() {this.echo('ERROR - cannot find //input[@id="username"]').exit();});}});

casper.then(function() {techo('wait 1');});
casper.then(function() {casper.wait(1000, function() {});});

casper.then(function() {{techo('dclick //input[@id="password"]');
casper.waitFor(function check() {return check_tx('//input[@id="password"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@id="password"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@id="password"]').exit();});}});

casper.then(function() {techo('wait 1');});
casper.then(function() {casper.wait(1000, function() {});});

casper.then(function() {{techo('enter //input[@id="password"] as '+psw+'');
casper.waitFor(function check() {return check_tx('//input[@id="password"]');},
function then() {chrome.sendKeys(tx('//input[@id="password"]'),''+psw+'');},
function timeout() {this.echo('ERROR - cannot find //input[@id="password"]').exit();});}});

casper.then(function() {techo('wait 1');});
casper.then(function() {casper.wait(1000, function() {});});

casper.then(function() {{techo('click //input[@class="ip_2"]');
casper.waitFor(function check() {return check_tx('//input[@class="ip_2"]');},
function then() {chrome.click(tx('//input[@class="ip_2"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@class="ip_2"]').exit();});}});

casper.then(function() {techo('wait 2');});
casper.then(function() {casper.wait(2000, function() {});});

//出现用户密码错误则说明账号或者密码错误
casper.then(function() {if ((present('//td[@class="td_1"]//font')))
{ // start of code block
...
casper.then(function() {{techo('write now+\'账号密码错误\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'账号密码错误');}});

casper.then(function() {{techo('write \'账号密码错误\' to /root/rpa_file/error.txt');
append_text('/root/rpa_file/error.txt','账号密码错误');}});
...
casper.then(function() {{techo('write now+\'输入账号密码\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'输入账号密码');}});
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://jx.sspu.edu.cn/eams/teach/grade/course/teacher.action'}); sleep(1000);
techo('https://jx.sspu.edu.cn/eams/teach/grade/course/teacher.action' + ' - ' + chrome.getTitle());});

casper.then(function() {techo('wait 1');});
casper.then(function() {casper.wait(1000, function() {});});

casper.then(function() {if ((present('//td[contains(text(),"'+course_series+'")]')))
{ // start of code block

casper.then(function() {{techo('read //td[contains(text(),"'+course_series+'")]/..//td[7] to total');
casper.waitFor(function check() {return check_tx('//td[contains(text(),"'+course_series+'")]/..//td[7]');},
function then() {total = chrome.fetchText(tx('//td[contains(text(),"'+course_series+'")]/..//td[7]')).trim();},
function timeout() {this.echo('ERROR - cannot find //td[contains(text(),"'+course_series+'")]/..//td[7]').exit();});}});

casper.then(function() {this.echo(total);});

//read //td[contains(text(),"'+course_series+'")]/..//td[8] to status
//echo status
casper.then(function() {{techo('read //td[contains(text(),"'+course_series+'")]/..//td[last()]//a[3]/@href to url');
casper.waitFor(function check() {return check_tx('//td[contains(text(),"'+course_series+'")]/..//td[last()]//a[3]/@href');},
function then() {url = chrome.fetchText(tx('//td[contains(text(),"'+course_series+'")]/..//td[last()]//a[3]/@href')).trim();},
function timeout() {this.echo('ERROR - cannot find //td[contains(text(),"'+course_series+'")]/..//td[last()]//a[3]/@href').exit();});}});
...
casper.then(function() {casper.thenOpen('about:blank', function() {
var download_path = flow_path; // to set path correctly for Windows
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'http://'+URL+''}); sleep(1000);
techo('http://'+URL+'' + ' - ' + chrome.getTitle());});}); // end of dynamic url block

casper.then(function() {techo('wait 2');});
casper.then(function() {casper.wait(2000, function() {});});

casper.then(function() {if ((present('//div[@id="tabPage2_1"]//td[6]//a[1]')))
{ // start of code block

casper.then(function() {if ((per[0]!=0))
{ // start of code block

casper.then(function() {{techo('dclick //input[@name="examGradeState3.percent"]');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState3.percent"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@name="examGradeState3.percent"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState3.percent"]').exit();});}});

casper.then(function() {{techo('enter  //input[@name="examGradeState3.percent"] as '+per[0]+'');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState3.percent"]');},
function then() {chrome.sendKeys(tx('//input[@name="examGradeState3.percent"]'),''+per[0]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState3.percent"]').exit();});}});

} // end of code block
});

casper.then(function() {if ((per[1]!=0))
{ // start of code block

casper.then(function() {{techo('dclick //input[@name="examGradeState31.percent"]');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState31.percent"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@name="examGradeState31.percent"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState31.percent"]').exit();});}});

casper.then(function() {{techo('enter  //input[@name="examGradeState31.percent"] as '+per[1]+'');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState31.percent"]');},
function then() {chrome.sendKeys(tx('//input[@name="examGradeState31.percent"]'),''+per[1]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState31.percent"]').exit();});}});

} // end of code block
});

casper.then(function() {if ((per[2]!=0))
{ // start of code block

casper.then(function() {{techo('dclick //input[@name="examGradeState32.percent"]');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState32.percent"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@name="examGradeState32.percent"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState32.percent"]').exit();});}});

casper.then(function() {{techo('enter  //input[@name="examGradeState32.percent"] as '+per[2]+'');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState32.percent"]');},
function then() {chrome.sendKeys(tx('//input[@name="examGradeState32.percent"]'),''+per[2]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState32.percent"]').exit();});}});

} // end of code block
});

casper.then(function() {if ((per[3]!=0))
{ // start of code block

casper.then(function() {{techo('dclick //input[@name="examGradeState1.percent"]');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState1.percent"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@name="examGradeState1.percent"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState1.percent"]').exit();});}});

casper.then(function() {{techo('enter  //input[@name="examGradeState1.percent"] as '+per[3]+'');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState1.percent"]');},
function then() {chrome.sendKeys(tx('//input[@name="examGradeState1.percent"]'),''+per[3]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState1.percent"]').exit();});}});

} // end of code block
});

casper.then(function() {if ((per[4]!=0))
{ // start of code block

casper.then(function() {{techo('dclick //input[@name="examGradeState2.percent"]');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState2.percent"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@name="examGradeState2.percent"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState2.percent"]').exit();});}});

casper.then(function() {{techo('enter  //input[@name="examGradeState2.percent"] as '+per[4]+'');
casper.waitFor(function check() {return check_tx('//input[@name="examGradeState2.percent"]');},
function then() {chrome.sendKeys(tx('//input[@name="examGradeState2.percent"]'),''+per[4]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@name="examGradeState2.percent"]').exit();});}});

} // end of code block
});

casper.then(function() {{techo('click //div[@id="tabPage2_1"]//td[4]//a[1]');
casper.waitFor(function check() {return check_tx('//div[@id="tabPage2_1"]//td[4]//a[1]');},
function then() {chrome.click(tx('//div[@id="tabPage2_1"]//td[4]//a[1]'));},
function timeout() {this.echo('ERROR - cannot find //div[@id="tabPage2_1"]//td[4]//a[1]').exit();});}});
...
casper.then(function() {{techo('write now+\'开始录入\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'开始录入');}});
...
//根据获得列的位置获取成绩
casper.then(function() {for (n=1; n<array_lines.length; n++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][n]';});
(function (n) { // start of IIFE pattern
{ // start of code block

//n=70主动暂存页面等待10秒
casper.then(function() {if (((n==70)))
{ // start of code block

casper.then(function() {{techo('click //input[@id="bnJustSave"]');
casper.waitFor(function check() {return check_tx('//input[@id="bnJustSave"]');},
function then() {chrome.click(tx('//input[@id="bnJustSave"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@id="bnJustSave"]').exit();});}});
...
casper.then(function() {if (((u1_col!=-1)))
{ // start of code block
...
casper.then(function() {if (((u2_col!=-1)))
{ // start of code block
...
casper.then(function() {if (((u3_col!=-1)))
{ // start of code block
...
casper.then(function() {if (((middle_col!=-1)))
{ // start of code block
...
casper.then(function() {if (((end_col!=-1)))
{ // start of code block
...
//网页上定位录入
casper.then(function() {if ((present('//td[contains(text(),"'+number[n]+'")]/preceding-sibling::td[1]')))
{ // start of code block

casper.then(function() {{techo('read //td[contains(text(),"'+number[n]+'")]/preceding-sibling::td[1] to id');
casper.waitFor(function check() {return check_tx('//td[contains(text(),"'+number[n]+'")]/preceding-sibling::td[1]');},
function then() {id = chrome.fetchText(tx('//td[contains(text(),"'+number[n]+'")]/preceding-sibling::td[1]')).trim();},
function timeout() {this.echo('ERROR - cannot find //td[contains(text(),"'+number[n]+'")]/preceding-sibling::td[1]').exit();});}});

casper.then(function() {if ((usual_1[n]!=''))
{ // start of code block

casper.then(function() {if ((present('//input[@id="USUALⅠ_'+id+'"]')))
{ // start of code block

casper.then(function() {{techo('dclick //input[@id="USUALⅠ_'+id+'"]');
casper.waitFor(function check() {return check_tx('//input[@id="USUALⅠ_'+id+'"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@id="USUALⅠ_'+id+'"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@id="USUALⅠ_'+id+'"]').exit();});}});

casper.then(function() {{techo('enter  //input[@id="USUALⅠ_'+id+'"] as '+usual_1[n]+'');
casper.waitFor(function check() {return check_tx('//input[@id="USUALⅠ_'+id+'"]');},
function then() {chrome.sendKeys(tx('//input[@id="USUALⅠ_'+id+'"]'),''+usual_1[n]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@id="USUALⅠ_'+id+'"]').exit();});}});
...
casper.then(function() {if ((usual_2[n]!=''))
{ // start of code block

casper.then(function() {if ((present('//input[@id="USUALⅡ_'+id+'"]')))
{ // start of code block

casper.then(function() {{techo('dclick //input[@id="USUALⅡ_'+id+'"]');
casper.waitFor(function check() {return check_tx('//input[@id="USUALⅡ_'+id+'"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@id="USUALⅡ_'+id+'"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@id="USUALⅡ_'+id+'"]').exit();});}});

casper.then(function() {{techo('enter  //input[@id="USUALⅡ_'+id+'"] as '+usual_2[n]+'');
casper.waitFor(function check() {return check_tx('//input[@id="USUALⅡ_'+id+'"]');},
function then() {chrome.sendKeys(tx('//input[@id="USUALⅡ_'+id+'"]'),''+usual_2[n]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@id="USUALⅡ_'+id+'"]').exit();});}});
...
casper.then(function() {if ((usual_3[n]!=''))
{ // start of code block

casper.then(function() {if ((present('//input[@id="USUALⅢ_'+id+'"]')))
{ // start of code block

casper.then(function() {{techo('dclick //input[@id="USUALⅢ_'+id+'"]');
casper.waitFor(function check() {return check_tx('//input[@id="USUALⅢ_'+id+'"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@id="USUALⅢ_'+id+'"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@id="USUALⅢ_'+id+'"]').exit();});}});

casper.then(function() {{techo('enter  //input[@id="USUALⅢ_'+id+'"] as '+usual_3[n]+'');
casper.waitFor(function check() {return check_tx('//input[@id="USUALⅢ_'+id+'"]');},
function then() {chrome.sendKeys(tx('//input[@id="USUALⅢ_'+id+'"]'),''+usual_3[n]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@id="USUALⅢ_'+id+'"]').exit();});}});
...
casper.then(function() {if ((middle[n]!=''))
{ // start of code block

casper.then(function() {if ((present('//input[@id="MIDDLE_'+id+'"]')))
{ // start of code block

casper.then(function() {{techo('dclick //input[@id="MIDDLE_'+id+'"]');
casper.waitFor(function check() {return check_tx('//input[@id="MIDDLE_'+id+'"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@id="MIDDLE_'+id+'"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@id="MIDDLE_'+id+'"]').exit();});}});

casper.then(function() {{techo('enter  //input[@id="MIDDLE_'+id+'"] as '+middle[n]+'');
casper.waitFor(function check() {return check_tx('//input[@id="MIDDLE_'+id+'"]');},
function then() {chrome.sendKeys(tx('//input[@id="MIDDLE_'+id+'"]'),''+middle[n]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@id="MIDDLE_'+id+'"]').exit();});}});
...
casper.then(function() {if ((end[n]!=''))
{ // start of code block

casper.then(function() {if ((present('//input[@id="END_'+id+'"]')))
{ // start of code block

casper.then(function() {{techo('dclick //input[@id="END_'+id+'"]');
casper.waitFor(function check() {return check_tx('//input[@id="END_'+id+'"]');},
function then() {chrome.mouse.doubleclick(tx('//input[@id="END_'+id+'"]'));},
function timeout() {this.echo('ERROR - cannot find //input[@id="END_'+id+'"]').exit();});}});

casper.then(function() {{techo('enter  //input[@id="END_'+id+'"] as '+end[n]+'');
casper.waitFor(function check() {return check_tx('//input[@id="END_'+id+'"]');},
function then() {chrome.sendKeys(tx('//input[@id="END_'+id+'"]'),''+end[n]+'');},
function timeout() {this.echo('ERROR - cannot find //input[@id="END_'+id+'"]').exit();});}});
...
casper.then(function() {{techo('write csv_row(item_info) to wrong.csv');
append_text('/root/record_scores/wrong.csv',csv_row(item_info));}});
...
casper.then(function() {{techo('write now+\'结束录入\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'结束录入');}});
...
casper.then(function() {{techo('write now+\'开始校对\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'开始校对');}});

//读网页上所有学号
casper.then(function() {for (n=1; n<=total; n++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][n]';});
(function (n) { // start of IIFE pattern
{ // start of code block
...
casper.then(function() {if ((present('//*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[2]/text()')))
{ // start of code block
...
casper.then(function() {{techo('read //*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[2]/text() to wnumber');
casper.waitFor(function check() {return check_tx('//*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[2]/text()');},
function then() {wnumber = chrome.fetchText(tx('//*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[2]/text()')).trim();},
function timeout() {this.echo('ERROR - cannot find //*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[2]/text()').exit();});}});

casper.then(function() {this.echo(wnumber);});

casper.then(function() { // start of JS code
web_number = [wnumber]
}); // end of JS code

casper.then(function() {{techo('write csv_row(web_number) to web_number.csv');
append_text('/root/record_scores/web_number.csv',csv_row(web_number));}});

} // end of code block
});

casper.then(function() {if ((present('//*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[9]/text()')))
{ // start of code block

casper.then(function() {{techo('read //*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[9]/text() to wnumber');
casper.waitFor(function check() {return check_tx('//*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[9]/text()');},
function then() {wnumber = chrome.fetchText(tx('//*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[9]/text()')).trim();},
function timeout() {this.echo('ERROR - cannot find //*[@id="gradeForm"]/table[2]/tbody/tr['+id+']/td[9]/text()').exit();});}});
...
casper.then(function() {{techo('write now+\'结束校对\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'结束校对');}});

casper.then(function() {{techo('snap page to /root/rpa_file/'+course_series+'.png');
chrome.capture('/root/rpa_file/'+course_series+'.png');}});
...
casper.then(function() {{techo('write now+\'录分流程结束\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'录分流程结束');}});
...
casper.then(function() {{techo('write now+\'课程已发布\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'课程已发布');}});
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://jx.sspu.edu.cn/eams/teach/grade/course/teacher!taskList.action?lesson.semester.id=682'}); sleep(1000);
techo('https://jx.sspu.edu.cn/eams/teach/grade/course/teacher!taskList.action?lesson.semester.id=682' + ' - ' + chrome.getTitle());});
...
casper.then(function() {{techo('read //td[contains(text(),"'+course_series+'")]/..//td[8] to status');
casper.waitFor(function check() {return check_tx('//td[contains(text(),"'+course_series+'")]/..//td[8]');},
function then() {status = chrome.fetchText(tx('//td[contains(text(),"'+course_series+'")]/..//td[8]')).trim();},
function timeout() {this.echo('ERROR - cannot find //td[contains(text(),"'+course_series+'")]/..//td[8]').exit();});}});

casper.then(function() {this.echo(status);});
...
casper.then(function() {{techo('write now+\'课程序号错误\' to /root/rpa_file/log.txt');
append_text('/root/rpa_file/log.txt',now+'课程序号错误');}});

casper.then(function() {{techo('write \'课程序号错误\' to /root/rpa_file/error.txt');
append_text('/root/rpa_file/error.txt','课程序号错误');}});
